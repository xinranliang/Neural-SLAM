...
master_scene_dir = "/home/xinranliang/projects/interactive-robustness/neural-slam/data/scene_datasets/gibson_semantic/"
master_save_dir = '/home/xinranliang/projects/neural-slam/logs/2023-03-04/pretrain_rollouts/'
...
def get_habitat_dicts_temp(scene_str):
    dataset_dicts = []
    for file_name in os.listdir(os.path.join(master_save_dir, "%s/dict" % (scene_str))):
